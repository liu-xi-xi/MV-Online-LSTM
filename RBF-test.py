...
#读数据
# 点位1数据
dataframe1 = pd.read_excel(r'C:/Users/win10/Desktop/论文/练习/代码 - 副本/插值5/第一点位.xlsx', header=None)
dataset1 = dataframe1.values  # 转换为numpy.ndarray数据
dataset1 = dataset1.astype('float32')  # 保障数据精度的同时还要考虑计算效率

# --------------------------点位2数据的处理---------------------------
dataframe2 = pd.read_excel(r'C:/Users/win10/Desktop/论文/练习/代码 - 副本/插值5/第二点位.xlsx', header=None)
dataset2 = dataframe2.values  # 转换为numpy.ndarray数据

dataset2 = dataset2.astype('float32')  # 保障数据精度的同时还要考虑计算效率

# --------------------------点位3数据的处理---------------------------
dataframe3 = pd.read_excel(r'C:/Users/win10/Desktop/论文/练习/代码 - 副本/插值5/第三点位.xlsx', header=None)
dataset3 = dataframe3.values  # 转换为numpy.ndarray数据

dataset3 = dataset3.astype('float32')  # 保障数据精度的同时还要考虑计算效率

# --------------------------点位4数据的处理---------------------------
dataframe4 = pd.read_excel(r'C:/Users/win10/Desktop/论文/练习/代码 - 副本/插值5/第四点位.xlsx', header=None)
dataset4 = dataframe4.values  # 转换为numpy.ndarray数据

dataset4 = dataset4.astype('float32')  # 保障数据精度的同时还要考虑计算效率

# --------------------------点位5数据的处理---------------------------
dataframe5 = pd.read_excel(r'C:/Users/win10/Desktop/论文/练习/代码 - 副本/插值5/第五点位.xlsx', header=None)
...
model = load_model('RBF3.h5',custom_objects={'RBFLayer': RBFLayer})
...
savepath = 'C:/Users/win10/Desktop/论文/练习/code/RBF/RBF_1.xls'
...
savepath = 'C:/Users/win10/Desktop/论文/练习/code/RBF/RBF_2.xls'
book.save(savepath)
...
savepath = 'C:/Users/win10/Desktop/论文/练习/code/RBF/RBF_3.xls'
book.save(savepath)
...
savepath = 'C:/Users/win10/Desktop/论文/练习/code/RBF/RBF_4.xls'
book.save(savepath)
...
savepath = 'C:/Users/win10/Desktop/论文/练习/code/RBF/RBF_5.xls'
