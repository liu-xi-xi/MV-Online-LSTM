...
model = load_model('AT-LSTM3.h5')
yhat = model.predict(testX)
train = data[:286,:]
print("train shape:", train.shape)
print("yhat shape:", yhat.shape)
# 检查 train 和 yhat 数组的形状是否匹配
if train.shape[0] != yhat.shape[0]:
    # 通过去除 yhat 数组的额外维度来调整形状
...
savepath = 'C:/Users/win10/Desktop/练习/SV-MV/注意力机制的LSTM学习/Attention_1.xls'
...
savepath = 'C:/Users/win10/Desktop/练习/SV-MV/注意力机制的LSTM学习/Attention_2.xls'
book.save(savepath)
...
savepath = 'C:/Users/win10/Desktop/练习/SV-MV/注意力机制的LSTM学习/Attention_3.xls'
book.save(savepath)
...
savepath = 'C:/Users/win10/Desktop/练习/SV-MV/注意力机制的LSTM学习/Attention_4.xls'
book.save(savepath)
...
savepath = 'C:/Users/win10/Desktop/练习/SV-MV/注意力机制的LSTM学习/Attention_5.xls'
book.save(savepath)
